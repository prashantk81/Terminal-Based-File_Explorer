...
void create_dir_cmd(vector<string> cmd_mod)
{
    ...
    if(ss<3 || ss>3){
        ...
        string dest_folder_loc=Absolute_path_find(cmd_mod[2]);
        string create_folder_name=cmd_mod[1];
        string dest_file_location=dest_folder_loc+"/"+create_folder_name;
...
void create_File_cmd(vector<string> cmd_mod)
{
    ...
    if(ss<3 || ss>3){
        ...
        string dest_directory=Absolute_path_find(cmd_mod[2]);
        string create_file_name=cmd_mod[1];
        string dest_file_location=dest_directory+"/"+create_file_name;
...
void print_directory(string str)
{
    struct stat jss;
    double size;
    char timing[100];
